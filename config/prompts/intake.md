...
3. Werk indien nodig deze velden bij: scope, assumptions, missing_inputs, research_plan, output_type, estimated_runtime_minutes, estimated_cost_eur. Kies output_type uitsluitend uit: {{available_output_types}}.
